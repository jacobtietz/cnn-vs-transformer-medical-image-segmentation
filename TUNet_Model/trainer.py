...
def trainer_synapse(args, model, snapshot_path):
    ...
    trainloader = DataLoader(
        db_train, batch_size=batch_size, shuffle=True, num_workers=0,
    ...
    for epoch_num in epoch_iterator:
        ...
        logging.info(
            f"Epoch {epoch_num} Train Loss: {train_loss_epoch:.4f}, "
        ...
        logging.info(
            f"Epoch {epoch_num} Val Loss: {val_loss_epoch:.4f}, "
